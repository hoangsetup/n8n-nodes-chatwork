...
export async function getContacts(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
	const contacts = (await chatworkApiRequest.call(this, 'GET', '/contacts')) as ContactResponse[];
	const me = (await chatworkApiRequest.call(this, 'GET', '/me')) as ContactResponse;
